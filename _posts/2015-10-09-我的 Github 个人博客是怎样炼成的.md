...
![Joey's Blog]({{site.baseurl}}/public/images/2015-10-09-1.png)
...
![Search GitHub education]({{site.baseurl}}/public/images/2015-10-09-2.png)

点击 Get the pack，如下图。

![Get the pack]({{site.baseurl}}/public/images/2015-10-09-3.png)

接下来，按照网站的要求填写个人信息[你需要拥有校园网邮箱证明你的学生身份，才可以享受福利]。提交表单后，GitHub 需要1-2周的时间审核你的个人身份，然后你会收到这样一封邮件，受宠若惊有木有，反正当时我的内心是，还有服务这么好的公司。

![Email Screenshot]({{site.baseurl}}/public/images/2015-10-09-5.jpeg)
...
![My pack]({{site.baseurl}}/public/images/2015-10-09-6.png)
...
![Github pages]({{site.baseurl}}/public/images/2015-10-09-7.png)

按照官网教程，不急，我们一步一步来。

**官网第一步：**

![Create a repository]({{site.baseurl}}/public/images/2015-10-09-8.png)

第一步，登陆 GitHub，新建一个 repository, 命名为 `你的用户名 + github.io`。如我的用户名为 `joeyqiang`，所以 repository 命名为 `joeyqiang.github.io`，如下图。

![New a respository]({{site.baseurl}}/public/images/2015-10-09-9.png)

**官网第二步：**

![Paste_Image.png]({{site.baseurl}}/public/images/2015-10-09-10.png)

我的电脑是 Mac, 选择 GitHub for Mac，然后将线上的 repository 克隆到本地 (我下载了 Github Desktop 用于同步，你也可以使用 Git 同步，看个人喜好)。
Clone 后，你会看到如下界面。

![Paste_Image.png]({{site.baseurl}}/public/images/2015-10-09-11.png)

**官网第三步：**

![Create an index file]({{site.baseurl}}/public/images/2015-10-09-12.png)

好吧，打开 ATOM 编辑器，新建 index.html，输入你心中此时此刻所想，保存，如下图。

![ATOM Screenshot]({{site.baseurl}}/public/images/2015-10-09-13.png)

**官网第四步：**

![Commit & Sync]({{site.baseurl}}/public/images/2015-10-09-14.png)

打开 GitHub Desktop, 提交更新。

![Commit to master]({{site.baseurl}}/public/images/2015-10-09-15.png)

**官网第五步：**

![Go to the page]({{site.baseurl}}/public/images/2015-10-09-16.png)

打开你的浏览器，输入你刚建的 repository 的文件名，比如我输入 `joeyqiang.github.io`。 Bang! You get it. 如下图。

![Browse your blog]({{site.baseurl}}/public/images/2015-10-09-17.png)

现在我们可以绑定私人域名到上面啦。该上文的 Namecheap 登场了。利用 GitHub 礼包中的 unique link 链接到 Namecheap Education。

![Namecheap]({{site.baseurl}}/public/images/2015-10-09-18.png)

输入你喜欢的域名，完成订单。

![Order custom domain]({{site.baseurl}}/public/images/2015-10-09-19.png)

注册 Namecheap，登陆你的帐号，点击 Domain List, 然后点击 MANAGE，如下图。

![Manage domain]({{site.baseurl}}/public/images/2015-10-09-20.png)

点击 Advanced DNS。

![Manage DNS]({{site.baseurl}}/public/images/2015-10-09-21.png)

管理 DNS。

![Manage DNS]({{site.baseurl}}/public/images/2015-10-09-22.png)

添加 A Record，最终结果如下图。

![Add record]({{site.baseurl}}/public/images/2015-10-09-23.png)

打开 GitHub，新建一个 file，如下图。

![Create a file]({{site.baseurl}}/public/images/2015-10-09-24.png)

将 file 命名为 CNAME (全部为大写)，然后添加你的个人域名 (不要带 http 前缀)，保存，pull request 到 master, 如下图。

![Edit the file]({{site.baseurl}}/public/images/2015-10-09-25.png)

我们现在打开浏览器，输入你刚购买的域名，我的是`joeyqiang.me`，出现了，出现了，出现了，有木有！！！如下图。

![Browser screenshot]({{site.baseurl}}/public/images/2015-10-09-26.png)
...
![Create Gemfile]({{site.baseurl}}/public/images/2015-10-09-29.png)

运行 terminal，使用命令行移至 repository 根目录下 (也可以直接在 GitHub Desktop 下右键 repository 打开)，如下图。

![Command line to terminal]({{site.baseurl}}/public/images/2015-10-09-30.png)

![Right click to root directory]({{site.baseurl}}/public/images/2015-10-09-31.png)
...
![Running Jekyll]({{site.baseurl}}/public/images/2015-10-09-32.png)

下面，就可以使用 Jekyll 啦，本地测试在浏览器输入 `http://localhost:4000`即可 (本地测试结束后 commit to master 提交线上即可)，如下图。

![Local server]({{site.baseurl}}/public/images/2015-10-09-33.png)
...
![Blog Structure]({{site.baseurl}}/public/images/2015-10-09-34.png)
...
> 愿政府相信人民的判断力，早日解开网的牢笼，释放精神的桎梏。<br/>
  —— 野子Joey
